...
ECDAA_DEPENDENCIES += $(if $(BR2_PACKAGE_ECDAA_USE_LIBSODIUM),libsodium,)
...
ifeq ($(BR2_PACKAGE_ECDAA_USE_LIBSODIUM),n)
	ECDAA_CONF_OPTS += -DDISABLE_LIBSODIUM_RNG_SEED_FUNCTION=ON
endif
